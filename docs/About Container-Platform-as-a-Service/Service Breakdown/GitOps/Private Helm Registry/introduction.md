...
2. [**OpenShift Configuration**](../../../../OpenShift%20Tenants/Tenant%20features/GitOps/private-helm-registry-openshift-tenant.md) - Add the ACR credentials to the OpenShift Tenant (or Team overlay)
