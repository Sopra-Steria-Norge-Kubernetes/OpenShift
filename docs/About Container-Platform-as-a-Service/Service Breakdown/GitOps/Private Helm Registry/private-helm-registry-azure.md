...
2. Configure Authentication for Argo CD 
    1. [Method 1 - Configuring ACR Access Token Authentication](#method-1-configure-acr-access-token)
    2. [Method 2 - Configuring App Registration Authentication](#method-2-configuring-app-registration-authentication)
